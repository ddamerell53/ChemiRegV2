...
class CustomFloatFields(models.Model):
    custom_field = models.ForeignKey(CustomField, models.DO_NOTHING, blank=True, null=True)
...
class CustomForeignKeyField(models.Model):
    ...
    parent_project = models.ForeignKey(Entity, models.DO_NOTHING, blank=True, null=True)
    entity = models.ForeignKey(Entity, models.DO_NOTHING, blank=True, null=True)
    insert_transaction_id = models.BigIntegerField()
    update_transaction_id = models.BigIntegerField(blank=True, null=True)
    archived_transaction_id = models.BigIntegerField(blank=True, null=True)
...
class CustomVarcharField(models.Model):
    custom_field = models.ForeignKey(CustomField, models.DO_NOTHING, blank=True, null=True)
...
class FileUploads(models.Model):
    compound = models.ForeignKey(Entity, models.DO_NOTHING, blank=True, null=True)
